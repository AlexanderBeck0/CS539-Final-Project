...
class Node:
    ...
    def __init__(self, X, Y, i=None, C=None, isleaf=False, p=None):
        self.X: np.ndarray = X
        """
        The data instances in the node, a numpy matrix of shape p by n.
        Each element can be int/float/string.
        Here n is the number data instances in the node, p is the number of attributes.
        """
        self.Y: np.ndarray = Y
        """
        the class labels, a numpy array of length n. Each element can be int/float/string.
        """
        self.i: int = i or -1
        """
        The index of the attribute being tested in the node, an integer scalar 
        """
        self.C: dict = C or {}
        """
        The dictionary of attribute values and children nodes. 
        Each (key, value) pair represents an attribute value and its corresponding child node.
        """
        self.isleaf = isleaf
        """
        Whether or not this node is a leaf node, a boolean scalar
        """
        self.p: Any = p
